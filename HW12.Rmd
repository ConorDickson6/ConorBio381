...
# Transform X-variable into log2 scale
...
# add correlation coefficients to each group
p2 <- ggplot(Puromycin, aes(x = conc, y = rate, color = state), add = "reg.line",# Add regressin line
